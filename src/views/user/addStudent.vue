...
export default {
  ...
  // computed: {
  //   downLoadFile() {
  //     return `${this.baseurl}img/新增学生导入模版.xls`;
  //   }
  // },
  mounted() {
    this.getData();
    this.renderStripe();
    if (this.falg) {
      this.placeholder2 = "部门选择";
      this.placeholder3 = "分组选择";
      this.placeholder4 = "职务选择";
      this.placeholder5 = "搜索教师";
      this.student = "新增教师";
    } else {
      this.placeholder2 = "年级选择";
      this.placeholder3 = "类型选择";
      this.placeholder4 = "班级选择";
      this.placeholder5 = "搜索学生";
      this.student = "新增学生";
    }
  },
  methods: {
